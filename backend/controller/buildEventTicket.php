...
// function getCurrency($SESSION["ref_id"]){
//     $query = $GLOBALS["conn"]->query("SELECT currency FROM ti");
// }
...
function bookTicket($event_id, $t_c, $q){
		...
		if($res == "error"){
	        ...
	        $query = mysqli_query($GLOBALS["conn"], "INSERT INTO booked_event_tickets (booking_id, ticket_id, total, email_address,fname,lname, Payment) 
